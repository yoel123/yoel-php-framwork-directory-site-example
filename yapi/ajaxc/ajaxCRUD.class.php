            ...
            if ($_REQUEST['table'] == $this->db_table){
                ...
                if ($string_submitted_values != ''){
                    if (!$this->on_add_specify_primary_key && $this->primaryKeyAutoIncrement){
                        ...
                        $string_fields_without_pk = "`".$string_fields_without_pk."`";
	...
	function showTable(){
        ...
        */
        ...
        if ($this->add){
            ...
            $add_html .= "<form action=\"\" id=\"add_form_$this->db_table\" method=\"POST\" ENCTYPE=\"multipart/form-data\" style=\"display:none;\">\n";
