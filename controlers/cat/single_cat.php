...
$view->dirs = $dir->get_where("cats_id =  '$cat_id'");//get all directoris in this cat;
$view->title = $view->cat['name']; 
$view->inner = true; 
$view->no_search = true; //disable search

//featured dirs
$view->featured = $cat->query("SELECT * FROM dir LEFT JOIN featured ON featured.dir_id=dir.id WHERE featured.cat_id=".$cat_id);
